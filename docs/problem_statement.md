...
2. Who are the users?
The users could be the following entities:
- city planners: to find which places and roads needs redesigns
- Policy researchers: to see if interventions are actually reducing accidents
...
4. What is outside the scope of the project?
- The system will not predict the accident.
...
Simpler methods are enough here to create dashboards, count accidents and heatmaps based on the data alone. ML is useful mainly to find accident patterns, how two roads are similar, and to find trends which might accout for repairs required immediately or which places need attention and whatnot.

6. What do you personally want to learn from this project?
- I want to understand how production ML systems evolve.
- I want to become comfortable designing software instead of only notebooks.
- I want to gain confidence explaining architectural decisions.
- I want to understand why companies use CI/CD rather than just how to configure it.

7. When this project is finished, what do you want someone reviewing your GitHub repository to think about you?
I want this person to see my ability to design a robust system on a production environment and my expertise on these tools that have been used and see me as a full fledged engineer that can take a real world problem and build a decision support system towards the solution of that problem.